        ...
        <div className="absolute bottom-0 left-0 pb-6 px-2 md:px-10">
          <form onSubmit={addComment} className="flex items-center">
            <input
              ...
              className="bg-primary px-6 py-2 text-md font-medium border-2 w-[250px] 
                     md:w-[700px] lg:w-[350px] border-gray-100 focus:outline-none focus:border-2 focus:border-gray-300 flex-1 rounded-lg"
            />
            <div className="rounded-full bg-[#F51997] p-[5px] ml-1 flex items-center">
              <button className="text-2xl text-gray-300" onClick={addComment}>
                {isPostingComment ? <FaRegCommentDots /> : <IoMdSend />}
              </button>
            </div>
          </form>
        </div>
